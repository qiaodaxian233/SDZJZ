...
- **A Common-safe 可直迁**: 9 文件 / 843 行
- **B Legacy-coupled 需 SPI 剥离**: 93 文件 / 15501 行
...
|---|---|---|---|
| world/block | 61 | 1195 | WorldAdapter |
...
- Sdzjz.java（331 行 / 113 用点：network×42, world/block×42, screen×14, fabric-api×8）
