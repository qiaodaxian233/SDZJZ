...
## 核心调度公平性：方案①已落地（m302），评审复评通过（9→9.4）
...
判据=无长期零吞吐核心且最低最高吞吐只差几倍。工具已备：/sdzjz profile sched（m304 判据直出）
+ GameTest 公平性 soak（m305）。
