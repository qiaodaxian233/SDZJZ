...
## 当前状态（m201：合成终端接原版工作台接口——AbstractRecipeScreenHandler+槽序重排(合成0..8/结果9/展示10..63)+CraftingResultSlot 子类，EMI 零插件直通/原版配方书协议已通/JEI 需小插件(看板#15 待拍板)；m196~m201 均待作者实机验证
