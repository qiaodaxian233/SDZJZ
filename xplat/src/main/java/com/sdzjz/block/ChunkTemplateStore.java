...
public class ChunkTemplateStore extends SavedData {
    ...
    public static final SavedData.Type<ChunkTemplateStore> TYPE = new SavedData.Type<>(
            ChunkTemplateStore::new, ChunkTemplateStore::read, null);

    public static ChunkTemplateStore read(CompoundTag nbt, HolderLookup.WrapperLookup lookup) {
