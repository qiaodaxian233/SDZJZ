 ...
 *  半径变更/开堵水=重扫（#zrd 同口径）。 */
public record ChunkRemoverConfigPayload(int hand, int radius, int mode, int seal) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, ChunkRemoverConfigPayload> CODEC = PacketCodec.tuple(
            ...
            PacketCodecs.INTEGER, ChunkRemoverConfigPayload::seal,
