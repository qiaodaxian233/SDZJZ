...
public class SdzjzConfig {
    ...
    public boolean chunkRemoverSealFluids = true; // m388 封边挡水总闸：开=移除器可勾选"封边挡水"（拆到区域边界时，外侧贴水/岩浆的位置放玻璃幕墙代替空气，堵住回灌；玻璃无精准采集不掉落，无白捡漏洞）；关=勾选无效按普通挖
