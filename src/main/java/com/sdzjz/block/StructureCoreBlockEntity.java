...
public class StructureCoreBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, Container {
    ...
    private static void tickInner(Level world, BlockPos pos, BlockState state, StructureCoreBlockEntity be) {
        ...
        for (int i = 0; i < nSize; i++) {
            ...
            if (StructureCoreBlockEntity.isDistributor(st)) {
                ...
                net.minecraft.core.BlockPos.Mutable mpS = new net.minecraft.core.BlockPos.Mutable();
                ...
                if (!accV.scanComplete) {
                    ...
                    net.minecraft.core.BlockPos.Mutable mpV = new net.minecraft.core.BlockPos.Mutable();
                ...
                net.minecraft.core.BlockPos.Mutable mpZ = new net.minecraft.core.BlockPos.Mutable();
    ...
    /** m394 远距送达（作者报"我现在看不到激光特效"的真根因）：原版 `ServerLevel.spawnParticles`
    ...
    private com.sdzjz.machine.StorageAccess resolveStorageAt(Level world, String dim, long posLong) {
        ...
        if (world instanceof net.minecraft.server.level.ServerLevel sw) {
            ...
            try {
                key = ResourceKey.of(BuiltInRegistries.WORLD, ResourceLocation.of(dim));
            } catch (Exception e) {
    ...
    private Level resolveDimWorld(Level base, String dim) {
        ...
        if (base instanceof net.minecraft.server.level.ServerLevel sw)
            return sw.getServer().getWorld(ResourceKey.of(BuiltInRegistries.WORLD, ResourceLocation.of(dim)));
        return null;
    }
    ...
    private StorageCoreBlockEntity boundPanel(Level world, BlockPos corePos) {
        ...
        ResourceKey<Level> dimKey = ResourceKey.of(BuiltInRegistries.WORLD, ResourceLocation.of(boundPanelDim));
    ...
    private void writeRenderNbt(CompoundTag nbt, HolderLookup.WrapperLookup lookup) {
    ...
    private void readRenderNbt(CompoundTag nbt, HolderLookup.WrapperLookup lookup) {
        machineNodes.clear();
        bumpTopo(); // m179
    ...
    public void applyRenderSnapshot(CompoundTag nbt, HolderLookup.WrapperLookup lookup) {
        readRenderNbt(nbt, lookup);
    }

    @Override
    public CompoundTag toInitialChunkDataNbt(HolderLookup.WrapperLookup lookup) {
        // m276：区块追踪初始同步瘦身——路过玩家（含 vanilla ClientboundBlockEntityDataPacket.create 默认取数）
    ...
    @Nullable
    @Override
    public AbstractContainerMenu createMenu(int syncId, Container inv, Player player) {
