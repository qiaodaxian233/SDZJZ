...
public class TermButton extends SciButton {
    ...
    public TermButton(int x, int y, int w, int h, Text t, PressAction a) { this(x, y, w, h, t, a, false); }

    public TermButton(int x, int y, int w, int h, Text t, PressAction a, boolean primary) {
        super(x, y, w, h, t, a);
    ...
    protected void renderWidget(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        SciSkin.termBtn(ctx, net.minecraft.client.MinecraftClient.getInstance().textRenderer,
