...
public class SdzjzConfig {
    ...
    public int portableVaultTypeCap = 256;      // 账本类型上限（只闸新类型，已有类型照常并账）。账本存物品组件，类数越大背包同步越重，慎调大
