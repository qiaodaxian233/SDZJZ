...
public class Sdzjz implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        com.sdzjz.screen.SuperBenchScreenHandler.installHost(new com.sdzjz.screen.LegacySuperBenchHost()); // m523（SB2b）超大工作台物品宿主口（压缩包/抓物笼，原句照搬）：早于任何开屏；菜单类型安装口在 ModScreenHandlers 静态段
